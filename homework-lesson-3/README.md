...
Цей проєкт реалізує дослідницького агента, який:
- працює в інтерактивному REPL-режимі через `python main.py`
- самостійно обирає tools для пошуку, читання сторінок і збереження Markdown-звіту
- зберігає контекст діалогу в межах сесії
- обмежує розмір tool output, щоб не перевантажувати контекст моделі
